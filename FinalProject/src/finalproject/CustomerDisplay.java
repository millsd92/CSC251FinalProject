...
/**
 *  This displays all customers and their associated data.
 * @author David Mills
 */
public final class CustomerDisplay extends JFrame implements WindowListener
{
    ...
    public CustomerDisplay(MainWindow previousWindow, Connection database)
    {
        this.previousWindow = previousWindow;
        setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
        setTitle("Coffee Shop - Display Customers");
        ...
        try (Statement displayCustomers = database.createStatement(
                ...
                ResultSet results = 
                        displayCustomers
                                .executeQuery("SELECT First_Name, Last_Name, "
        ...
        lblTop = new JLabel("<html><h1>Customer Data</h1></html>");
